        ...
        <Carousel fade>
          <Carousel.Item>
            ...
            <Carousel.Caption>
              ...
              <p>
                Paradise Hotel is a leading 5-star international standard hotel
                located right in the busy business, shopping, commercial and
                entertainment center of Binh Duong, about 5 km by road from the
                center. The place attracts many domestic and international
                tourists to visit every year.
              </p>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
              ...
              <div className="service-2-item">
                <div className="d-flex align-items-center">
                  <div className="flex-shrink-0">
                    <p className="service-2-fontawesome">
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div className="flex-grow-1 md-3">
                    <div className="service-2-item-content">
                      ...
                      <p>
                        Enthusiastic and attentive staff to pick you up at the
                        airport
                      </p>
                    </div>
                  </div>
